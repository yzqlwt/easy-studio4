...
class Index extends React.Component {
  ...
  componentDidMount() {
    ...
    addon.setCCSPath(
      'C:\\Users\\yzqlwt\\Documents\\WorkSpace\\cocos-ui-back\\mangomath-ui\\CocosProject.ccs'
    );
            ...
            <Layout.Content theme="light" style={{ padding: 30 }}>
              <div className="card-container">
                <Tabs
                  ...
                  type="card"
                >
                  <TabPane tab="输出" key="output" style={{ height: 400 }}>
                    <FileView
                  ...
                  <TabPane tab="动画音效" key="others" style={{ height: 500 }}>
                    <FileView
                      templateId={this.state.templateId}
                      skinId={this.state.skinId}
                      type="others"
                  ...
                  <TabPane tab="图片" key="image" style={{ height: 500 }}>
                    <FileView
                      templateId={this.state.templateId}
                      skinId={this.state.skinId}
                      type="image"
...
function stateToProps(state) {
  const { dataSkin, dataProperty, dataActivity } = state;
  return { dataSkin, dataProperty, dataActivity };
}
